...
*/
void PlotWidget::makePlot(QVector<double> x, std::function<double(double)> f, int graphNr, bool rescale, QColor color)
{
 ...
 * Plot (x,y)
*/
void PlotWidget::makePlot(QVector<double> x, QVector<double> y, int graphNr, bool rescale, QColor color)
{
	plot->addGraph();
