#############################################################################
# Makefile for building: build/Wavedit
# Generated by qmake (3.1) (Qt 5.15.13)
# Project:  Wavedit.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Wavedit.pro
#############################################################################
...
INCPATH       = -I. -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -Ibuild -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Wavedit1.0.0
DISTDIR = /home/gooosz/Uni/4Semester/Uebungen/NumerischeDatenanalyse/Projekt/Wavedit/build/Wavedit1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Wavedit.pro  MyWindow.cpp \
		main.cpp
QMAKE_TARGET  = Wavedit
DESTDIR       = build/
TARGET        = build/Wavedit


first: all
####### Build rules

build/Wavedit:  $(OBJECTS)  
	@test -d build/ || mkdir -p build/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Wavedit.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents MyWindow.cpp main.cpp $(DISTDIR)/
...
build/moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -flto -fno-fat-lto-objects -Wall -Wextra -dM -E -o build/moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
...
build/MyWindow.o: MyWindow.cpp MyWindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/MyWindow.o MyWindow.cpp

build/main.o: main.cpp MyWindow.h
